...
chrome.runtime.sendMessage(
    ...
    function (response) {
		...
		if (response!="")
		{
			...
			$(`<button style="color: white; padding: 10px;border-radius: 4px;text-shadow: 0 1px 1px rgba(0, 0, 0, 0.2);background: rgb(28, 184, 65);"><a href=${dlurl} style="color: white;" target="_blank">$(response[1][0])</a></button>`).insertAfter(".wtrButtonContainer");
	}
		else
